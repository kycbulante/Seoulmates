                    ...
                    <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" required name="name" id = "name" placeholder="Ener your full name" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="fw-bold">Email</label>
                                <input type="email" required name="email" id = "email" placeholder="Ener your email" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="fw-bold">Phone</label>
                                <input type="text" required name="phone" id = "phone" placeholder="Ener your phone number" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="fw-bold">Pin Code</label>
                                <input type="text" required name="pincode" id="pincode" placeholder="Ener your pincode" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
