...
else if (isset($_POST['add_product_btn']))
{
    ...
    $product_query = "INSERT INTO products (category_id,product_title, product_description, price, qty, image)
    VALUES ('$category_id','$product_title', '$product_description', '$price', '$qty', '$filename')";
...
else if (isset($_POST['update_product_btn']))
{
    ...
    $update_product_query = "UPDATE products SET category_id='$category_id', product_title = '$product_title', product_description='$product_description', price='$price', qty='$qty', image='$update_filename' WHERE id='$product_id'";
